...
<script>
    export default {
        ...
        beforeMount(){
            ...
            fetch('/api/orders/', {headers:this.headers}).then(response => response.json()).then(response =>{
        ...
        methods: {
            deliver(index) {
               ...
               fetch(`/api/orders/${order.id}/deliver`, {method:"PATCH", headers:this.headers}).then(response => response.json()).then(response => {
