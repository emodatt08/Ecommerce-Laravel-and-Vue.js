<template>
    <div>
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <router-link :to="{name: 'home'}" class="navbar-brand">Sellify</router-link>
    ...
    export default {
        data() {
            return {
                name: null,
                user_type: 0,
                isLoggedIn: localStorage.getItem('sellify.jwt') != null
            }
        },
        mounted() {
            this.setDefaults()
        ...
        methods : {
            ...
            logout(){
                localStorage.removeItem('sellify.jwt')
                localStorage.removeItem('sellify.user')
                this.change()
                this.$router.push('/')
            }
        }
